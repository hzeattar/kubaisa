...
function LuxuryRoomShell() {
  return (
    <group>
      ...
      <ContactShadows frames={1} resolution={256} position={[0, 0, 0]} scale={40} blur={3} far={10} opacity={0.5} color="#111111" />
...
export const ModernBedroom: React.FC = () => {
  return (
    <group>
      <LuxuryRoomShell />
      <ProductPedestal position={[0, 0, -2]} label="MODERN BEDROOM COLLECTION" />
