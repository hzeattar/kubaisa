...
export const ModernDining: React.FC = () => {
  return (
    <group>
      <LuxuryRoomShell />
      
      {/* Centerpiece Pedestal */}
      <ProductPedestal position={[0, 0, -2]} label="MODERN DINING COLLECTION" />
      
      {/* Side Pedestals */}
      <ProductPedestal position={[-7, 0, 2]} label="DINING CHAIR" />
      <ProductPedestal position={[7, 0, 2]} label="DINING TABLE" />
    </group>
  );
};
